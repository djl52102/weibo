  ...
  <div class="header_main">
   ...
   <div id="main">
    ...
    <div class="main_right">
        <h2>个人设置</h2>
        <dl>
            <dd>帐号名称:<?php echo ($user[0]['username']); ?></dd>
            <dd>电子邮箱:<input type="text" name="email" class="text" value="<?php echo ($user[0]['email']); ?>"><strong style="color:red;">*</strong></dd>
            <dd><span>个人简介:</span><textarea name="intro"><?php echo ($user[0]["extend"]["intro"]); ?></textarea></dd>
